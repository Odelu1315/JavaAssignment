...
package com.deeps.firstsprbootproj.test;
...
import com.deeps.firstsprbootproj.controller.TravellerRestController;
import com.deeps.firstsprbootproj.entity.Traveller;
import com.deeps.firstsprbootproj.repo.TravellerRepository;
import com.deeps.firstsprbootproj.service.TravellerService;
...
public class TravellerRestControllerTest {
    ...
    @InjectMocks
    private TravellerRestController travellerRestController;
    ...
    public void testHelloAppln() {
        String result = travellerRestController.helloAppln();
